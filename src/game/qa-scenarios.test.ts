...
describe("alpha v0.9.3 QA scenarios", () => {
  ...
  it("creates a v0.53 office visual scenario for final-art import browser QA", () => {
    ...
    expect(scenario.activeMenu).toBe("company");
    expect(scenario.label).toContain("최종 아트 임포트");
    expect(scenario.state.timeline[0]).toContain("v0.53 최종 아트 임포트");
