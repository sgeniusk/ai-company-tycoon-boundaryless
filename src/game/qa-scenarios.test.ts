...
describe("alpha v0.9.3 QA scenarios", () => {
  ...
  it("creates a v0.54 office visual scenario for object and backdrop import browser QA", () => {
    ...
    expect(scenario.activeMenu).toBe("company");
    expect(scenario.label).toContain("오브젝트/배경 임포트");
    expect(scenario.state.timeline[0]).toContain("v0.54 오브젝트/배경 임포트");
