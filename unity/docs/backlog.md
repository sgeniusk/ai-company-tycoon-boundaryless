...
## 기존 에셋 전부 반영 (포팅)
- [ ] 게임 화면 배경 — `public/assets/backgrounds/v054-isometric-office`(2560x1440)를 GameScreen 배경으로. 현재 단색 테마.
- [ ] 직원/오브젝트 스프라이트 — `public/assets/sprites`(v053 agents-event-poses, v054 office-objects, v076 workforce-actor).
- [ ] 미반영 UI 아틀라스 — v072 competitor-logo, v074 helper-portrait, v076 workforce-actor, v077 celebration-emblem, v078 world-reveal-stamp, v081 office-reaction. 현재 v071/v079/v080만 슬라이스.
