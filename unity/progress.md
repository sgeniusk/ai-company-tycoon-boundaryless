...
## 현재 상태 (Current State)
**마지막 갱신** — 2026-06-14
**활성 피처** — **feat-021 도감 열람 UI 완료** — 크로스런 수집 그리드 갤러리(더보기→도감). 3탭 아키타입12·엔딩24 잠금/해금(실루엣+???+조건힌트, MetaSave 추적) + 시너지/콤보20 전부공개(콤보 리스크뱃지). 신규 CollectionGallery.cs(818줄 자족) + GameScreen 도감 버튼1개, DataCatalog/MetaSave 읽기, 코어 무변경. 검증 EditMode 145/145 + PlayMode 5/5 + 캡처 19·19b·19c 3탭. 정본 docs/feat-021-context-notes.md.
