...
| --- | --- | --- | ---: | --- |
| fresh | `/?scenario=fresh` | PASS | 280483 | - |
...
| ten-year-ending-route-start | `/?scenario=ten-year-ending-route-start` | PASS | 313563 | - |
| ten-year-next-run | `/?scenario=ten-year-next-run` | PASS | 262145 | - |
| ending-nearmiss-retry-start | `/?scenario=ending-nearmiss-retry-start` | PASS | 312918 | - |
