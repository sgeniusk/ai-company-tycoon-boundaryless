# v0.46-alpha QA 보고서 — 고밀도 픽셀 시트 기반 사무실
...
- `npm test -- src/game/qa-scenarios.test.ts src/game/asset-manifest.test.ts src/ui/layout-contract.test.ts`
  - 결과: 통과
  - 범위: 3 files / 69 tests
- `sips -g pixelWidth -g pixelHeight public/assets/sprites/v046-agents-hires.png public/assets/sprites/v046-office-objects-hires.png public/assets/backgrounds/v046-isometric-office-hires.png`
  - 결과: 통과
  - 크기: 에이전트 576×1920, 오브젝트 1280×960, 배경 2560×1440
...
- `npm run assets:v046`
  - 결과: 통과
  - 산출물:
    - `public/assets/sprites/v046-agents-hires.png`
    - `public/assets/sprites/v046-office-objects-hires.png`
    - `public/assets/backgrounds/v046-isometric-office-hires.png`
...
- `curl -I http://127.0.0.1:5201/assets/sprites/v046-office-objects-hires.png`
  - 결과: 200 OK, `Content-Type: image/png`
- `curl -I http://127.0.0.1:5201/assets/backgrounds/v046-isometric-office-hires.png`
  - 결과: 200 OK, `Content-Type: image/png`
...
- 현재 Codex Node REPL 런타임에 `playwright` 모듈이 없어 DOM 스크린샷 자동 검증은 완료하지 못했다.
