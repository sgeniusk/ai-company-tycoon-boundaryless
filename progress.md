...
- Current feature: `v0.66-alpha-tag-derivation-engine` (PLANNED — awaiting user direction; the '무궁무진한 조합' centerpiece, decision A). The roguelike track has shipped end-to-end: `v0.63` system spine + `v0.64` content depth + `v0.65` difficulty, all CLOSED 2026-05-30. v0.65 = player-chosen challenge tiers (tier headwind + reward multiplier), 47 files / 481 tests. Master plan: `reports/v0_63_plus_content_roadmap.md`.
