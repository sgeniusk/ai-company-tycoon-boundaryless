...
- Current feature: `v0.65-alpha-difficulty-challenge` (in progress; player-chosen challenge tiers — tier-scaled monthly headwind + reward multiplier; tension-relief + open-challenge lever). Prior `v0.64-alpha-content-depth` CLOSED 2026-05-30 (data-only — #1 4-axis expansion 600->9,504 combos, #2 world-events 12->26 themed; 47 files / 472 tests). `v0.63-alpha-roguelike-run-modifiers` CLOSED 2026-05-30 (4 blocks). Master plan: `reports/v0_63_plus_content_roadmap.md`.
