...
- Current feature: `v0.66-alpha-tag-derivation-engine` (in progress; user-confirmed decision A — the '무궁무진한 조합' centerpiece. 4 blocks: engine -> discovery -> effects -> balance. #1 engine DONE). Roguelike track shipped end-to-end: `v0.63` spine + `v0.64` content + `v0.65` difficulty, all CLOSED 2026-05-30. Baseline 48 files / 488 tests. Master plan: `reports/v0_63_plus_content_roadmap.md`.
