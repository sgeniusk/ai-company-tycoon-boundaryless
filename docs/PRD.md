...
2026-05-15 기준 장르 축은 **로그라이트 덱빌딩 AI 회사 경영 게임**으로 전환합니다. 카이로소프트식 작은 회사 성장감은 유지하되, 매 런의 회사 전략을 카드 덱으로 만들고, 실패한 런은 창업 통찰과 메타 해금으로 다음 런에 남깁니다.
...
7. Deck choices and development puzzles make each run feel different.
8. Failure unlocks founder insight for the next company.
...
**Every failed AI startup becomes a better deck for the next one.**
...
- Against the Storm: 짧은 런, 메타 진행, 실패해도 다음 진행이 남는 도시 경영 로그라이트 감각.
- Stacklands: 카드가 자원, 건물, 행동을 동시에 표현하는 카드 기반 경영 감각.
- Potionomics: 상점 경영과 덱 기반 협상/성과 루프의 결합.
- Luck be a Landlord: 단순 경제 압박과 조합 시너지로 반복 플레이를 만드는 구조.
...
- "My failed company still taught the next founder something."
- "This deck makes this run feel like a different AI company."
...
6. Use strategy cards and development puzzles to improve active projects.
7. Repeat until success, failure, or the 10-minute MVP arc ends.
8. Convert the run into founder insight and start again with meta unlocks.
...
- Clean deck vs broad opportunity deck
- Fast launch vs high-quality launch
...
- Strategy deck with starter cards, hand, draw pile, discard pile, and card effects.
- Development puzzle that affects project progress and quality.
- Roguelite meta progression through founder insight and permanent unlocks.
...
- Full Slay the Spire-style card map, enemy combat, or hundreds of cards.
...
- At least 3 card strategy identities exist: fast launch, safe quality, automation efficiency.
...
- Founder Insight: meta currency earned from runs and spent on permanent unlocks.
