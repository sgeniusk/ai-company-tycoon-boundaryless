...
| Office Visuals | `?scenario=office-visuals` | v0.47 high-density sprite-sheet preview, isometric depth sorting, generated actors, decor props, and direct actor care actions |
...
## v0.47 Sprite Sheet Preview And Depth QA
...
- The QA pill says `v0.47 사무실 액터 시트 프리뷰/깊이 정렬 QA`.
