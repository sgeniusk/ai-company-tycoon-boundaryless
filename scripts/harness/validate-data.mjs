...
if (!Array.isArray(campaignEndings) || campaignEndings.length !== 24) {
  errors.push(`endings: expected exactly 24 campaign endings, found ${Array.isArray(campaignEndings) ? campaignEndings.length : "non-array"}`);
}
