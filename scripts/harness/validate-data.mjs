...
if (!Array.isArray(campaignEndings) || campaignEndings.length !== 22) {
  errors.push(`endings: expected exactly 22 campaign endings, found ${Array.isArray(campaignEndings) ? campaignEndings.length : "non-array"}`);
}
